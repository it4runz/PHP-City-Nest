...
<script type="text/javascript">
    window.location.href="manageproperties.php ";
</script>
            ...
            <div class="row mt">
              ...
              <div class="custom-bar-chart">
                <div class="table-responsive">
                                <table align="center" border=4 class="table table-hover" id="dev-table">
                                     <tr>
                                        <th>house ID</th>
...
?>
                                     <tr>
                                       ...
                                       <td>
         <a href="manageproperties.php?del123=<?php echo $row['houseid']?>" >Delete</a>
                                        </td>
